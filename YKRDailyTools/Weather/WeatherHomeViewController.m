...
@interface WeatherHomeViewController ()<MapManagerLocationDelegate, UITableViewDelegate, GetWeatherDataDelegate, WeatherViewDelegate, UIViewControllerTransitioningDelegate, FailedLongPressViewDelegate>
...
- (void)viewDidLoad {
    ...
    CGRect rectWeatherView = CGRectMake(0, StatusBarDelta + ptHeight7(20), Width, Height - StatusBarDelta);
