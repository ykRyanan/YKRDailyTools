...
#define StatusBarDelta ((CGFloat)((Width == 375.f && Height == 812.f) || (Width == 414.f && Height == 896.f)?34.f:0.f))
//#define StatusBarDelta [[UIApplication sharedApplication] statusBarFrame].size.height
